...
from src.utils.functions import write_df_to_paruqet
...
write_df_to_paruqet(result,cleansed_path)
...
result.write.jdbc(url='jdbc:mysql://carnext.c6cbiuhhyix3.eu-west-1.rds.amazonaws.com:3306',
