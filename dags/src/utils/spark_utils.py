...
def get_aws_spark_session(app_name):
    os.environ['PYSPARK_SUBMIT_ARGS'] = '--packages com.amazonaws:aws-java-sdk-pom:1.10.34,org.apache.hadoop:hadoop-aws:2.7.2,mysql:mysql-connector-java:5.1.39 pyspark-shell'
